...
public class loadList {
	public static List<userADT> userList = new ArrayList<userADT>();
	//public static List<twitterADT> twitterList = new ArrayList<twitterADT>();
	...
	public static void main(String args[]) throws FileNotFoundException {
		...
		for (int i = 0; s_twitter.hasNextLine(); i++) {
			...
			for (int j = 0; j < userList.size(); j++) {
				if (twitters.getId() == userList.get(j).getName()){
					userList.get(j).puttlist(twitters);
					break;
				}
			}
			////
